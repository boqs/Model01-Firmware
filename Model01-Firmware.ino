...
const Key keymaps[][ROWS][COLS] PROGMEM = {
  ...
  (Key_CapsLock,      Key_F1,           Key_F2,      Key_F3,     Key_F4,        Key_F5,           XXX,
   ...
   Key_PcApplication,          Key_Mute,               Consumer_VolumeDecrement, Consumer_VolumeIncrement, ___,             Key_NonUsBackslashAndPipe,    Key_Pipe,
